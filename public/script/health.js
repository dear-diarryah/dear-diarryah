document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Hole den API-Schlüssel vom Server
    ...
    document.getElementById("findDocButton").addEventListener("click", async function (event) {
        ...
        try {
            ...
            veterinarians.forEach(result => {
                ...
                const popup = new tt.Popup({ offset: 35 }).setText(`${poi.name}\n${address.freeformAddress}`);
